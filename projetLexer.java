// $ANTLR 3.5.2 src/projet.g 2018-04-04 09:28:09
...
public class projetLexer extends Lexer {
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/projet.g:208:5: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			// src/projet.g:208:9: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
			...
			// src/projet.g:208:28: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			loop1:
			while (true) {
				int alt1=2;
	...
	public final void mINT() throws RecognitionException {
		try {
			int _type = INT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/projet.g:212:5: ( ( '0' .. '9' )+ )
			// src/projet.g:212:9: ( '0' .. '9' )+
			{
			// src/projet.g:212:9: ( '0' .. '9' )+
			int cnt2=0;
			loop2:
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/projet.g:213:7: ( ( ' ' | '\\t' | '\\r' )+ )
			// src/projet.g:213:11: ( ' ' | '\\t' | '\\r' )+
			{
			// src/projet.g:213:11: ( ' ' | '\\t' | '\\r' )+
			int cnt3=0;
			loop3:
		...
		try {
			...
			switch (alt6) {
				case 1 :
					...
					break;
				case 2 :
					// src/projet.g:219:6: '#' (~ ( '\\r' | '\\n' ) )*
					{
					match('#'); 
					// src/projet.g:219:10: (~ ( '\\r' | '\\n' ) )*
					loop5:
					while (true) {
						int alt5=2;
	...
	public final void mML_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/projet.g:223:15: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// src/projet.g:223:19: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// src/projet.g:223:24: ( options {greedy=false; } : . )*
			loop7:
			while (true) {
				int alt7=2;
