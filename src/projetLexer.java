// $ANTLR 3.5.2 src/projet.g 2018-02-22 23:39:46
...
public class projetLexer extends Lexer {
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/projet.g:205:5: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			// src/projet.g:205:9: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
			...
			// src/projet.g:205:28: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			loop1:
			while (true) {
				int alt1=2;
	...
	public final void mINT() throws RecognitionException {
		try {
			int _type = INT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/projet.g:209:5: ( ( '0' .. '9' )+ )
			// src/projet.g:209:9: ( '0' .. '9' )+
			{
			// src/projet.g:209:9: ( '0' .. '9' )+
			int cnt2=0;
			loop2:
