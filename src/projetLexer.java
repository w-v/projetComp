// $ANTLR 3.5.2 src\\projet.g 2018-02-15 15:07:48
...
public class projetLexer extends Lexer {
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src\\projet.g:204:5: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			// src\\projet.g:204:9: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
			...
			// src\\projet.g:204:28: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			loop1:
			while (true) {
				int alt1=2;
	...
	public final void mINT() throws RecognitionException {
		try {
			int _type = INT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src\\projet.g:208:5: ( ( '0' .. '9' )+ )
			// src\\projet.g:208:9: ( '0' .. '9' )+
			{
			// src\\projet.g:208:9: ( '0' .. '9' )+
			int cnt2=0;
			loop2:
		...
		try {
			...
			switch (alt6) {
				case 1 :
					...
					break;
				case 2 :
					// src\\projet.g:214:6: '#' (~ ( '\\r' | '\\n' ) )*
					{
					match('#'); 
					// src\\projet.g:214:10: (~ ( '\\r' | '\\n' ) )*
					loop5:
					while (true) {
						int alt5=2;
	...
	public final void mML_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src\\projet.g:218:15: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// src\\projet.g:218:19: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// src\\projet.g:218:24: ( options {greedy=false; } : . )*
			loop7:
			while (true) {
				int alt7=2;
